      ...
      <div id="topnav">
        <div class="topnav_left">
          ...
          <div class="topnav-nav">
            ...
            <router-link class="topnav-nav-item" :to="`/products/all`"
              >Products</router-link
            >
            <router-link class="topnav-nav-item" :to="`/share`"
              >Share</router-link
            >
          </div>
        </div>
        ...
        <div class="row w-100 d-flex justify-content-center">
          <div class="col-12 col-lg-5 m-3">
            ...
            <div class="tall_content" :class="{ show: show1 }">
              <span class="text"
                >享家點的理念起源於為大多數人提供價格實惠的家具家飾，而非僅為了少數人。透過將功能、品質、設計和價值結合在一起，而且始終秉持著永續要素，並透過設計、採購、包裝、配送與經營業務模式，在每一個環節都體現享家點理念，實踐我們的願景：為大多數人創造更美好的生活。</span
              >
            </div>
          </div>
          <div class="col-12 col-lg-5 m-3">
            ...
            <div class="tall_content" :class="{ show: show2 }">
              <span class="text"
                >對我們來說，好的設計就是結合了形式、功能、品質、永續發展及人人負擔得起的價格。我們稱它為「大眾化設計」，因為我們相信好的家具是為每個人所設計。</span
              >
            </div>
          </div>
        </div>
        <div class="row w-100 d-flex justify-content-center">
          <div class="col-12 col-lg-5 m-3">
            ...
            <div class="tall_content" :class="{ show: show3 }">
              <span class="text"
                >我們的世界正在迅速變化，但我們對未來感到樂觀。
                我們相信，隨著時間的推移，越來越多的人可以並且將會擁有更美好的生活。要實現這一目標，需要強大的企圖心和對採取立即行動的承諾。它還意味著借由同心協力來應對我們無法單獨解決的重大挑戰。希望激勵並讓更多人實現永續的生活方式，同時既簡單也是人人負擔得起。通過改變我們的工作方式來實現這目標，對生態循環起正面的作用，並在各地都產生積極的社會影響。</span
              >
            </div>
          </div>
          <div class="col-12 col-lg-5 m-3">
