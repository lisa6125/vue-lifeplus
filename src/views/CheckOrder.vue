    ...
    <div class="container-fliud" v-if="cart.totalAmount>0">
      <div class="row">
        <div class="col-md-12 col-xl-8 mt-5 mx-auto">
          <form-wizard title subtitle @on-complete="submit" color="var(--brown3)" class="mt-5">
            <tab-content :title="steps[0]">
              <div class="container cart mt-5 border">
                <div class="row item p-3 border-bottom" v-for="data in cart.products" :key="data._id">
                  <div class="col-md-2" @click="goDetail(data._id)" style="cursor:pointer">
                  ...
                  <div class="col-md-10 d-flex flex-column justify-content-center">
                    <div class="row">
                      ...
                      <div class="col-6 col-md-3">
                        <p>單價</p> 
                        NT{{data.price | thousands}}</div>
                      <div class="col-6 col-md-3 mt-5 m-sm-0">
                        <p>數量</p> 
                        <b-form-spinbutton class="ml-2" id="sb-inline" inline min="1" max="50" v-model="data.quantity" @change='updatequantity(data)'></b-form-spinbutton>
                      </div>
                      <div class="col-6 col-md-3 mt-5 m-sm-0">
                        <p>小計</p>
                        <small>NT&ensp;</small>
                      ...
                      <div class="col-12 col-md-1 text-center mt-5 mb-3 m-md-0">
                        <button class="btn btn-remove" @click="removeProduct(data)">X</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <form class="row w-100 border-bottom mb-3 pb-5">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="username" value="connect.userName" v-model="connect.userName">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="userphone">收件人電話</label>
                      <input type="text" class="form-control" id="userphone" value="connect.userPhone" v-model="connect.userPhone">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">連絡信箱</label>
                      <input type="email" class="form-control" id="exampleInputEmail1" value="connect.userEmail" v-model="connect.userEmail">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="address">收件地址</label>
                      <input type="text" class="form-control" id="address" value="connect.userAddress" v-model="connect.userAddress">
                    </div>
                    <div class="form-group col-md-6">
            ...
            <tab-content :title="steps[2]">
              <div class="container">
                <div class="row item py-1 my-1 p-md-3 m-md-3 border-bottom d-flex justify-content-around align-items-center" v-for="data in cart.products" :key="data._id">
            ...
            <div class="container">
              <div class="row justify-content-end mt-4 cart-footer mb-4 m-sm-0">
                <div class="col-md-2 text-center mb-4">共&ensp;{{ cart.totalAmount}}&ensp;件商品</div>
...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      if(this.connect.userName === '' || this.connect.userEmail === '' || this.connect.userAddress === '' || this.connect.userPhone === '' || this.connect.userAddress === '未填寫' || this.connect.userPhone === '未填寫'){
      ...
      this.$router.push('/custom/orderdetail')
      .then(res=>{
      })
      .catch((err) => {
          this.$swal({
